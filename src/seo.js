...
export const ROUTES = {
  ...
  '/smart-homes': {
    ...
    description:
      'Geyser scheduling, leak detection and direct solar PV water heating. The Kwikot Elon Smart, Plentify HotBot and a DB board breaker, compared honestly.',
    schema: [
      organization,
      {
        '@type': 'Service',
